...
<body background="//localhost/lspmi/asset/picture/2.jpg">
    ...
    <div class="login">
        ...
        <form action="//localhost/lspmi/database/loginadmin.php" method="POST">
    ...
    <!-- <?php require 'koneksi.php';
     if(isset($_POST['login'])){
        ...
        $pesan ='';
        $redirect = '';
        $query = $conn->query("SELECT * FROM useradmin WHERE username='$username'");
        ...
        if(empty($get_data)){
            ...
            if($password != $get_data['password']){
                ...
                $redirect = '//localhost/lspmi/database/loginadmin.php';
            }
        }
