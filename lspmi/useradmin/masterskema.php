<?php
require 'koneksi.php';
$result = mysqli_query($conn, "SELECT * FROM skema");
        ...
        <div class="containerr">
            ...
            <div class="main-content">
                ...
                <div class="skema">
                    ...
                    <table class="tabel-skema">
                        <tr class="judul-skema">
                            <th>No.</th>
                            <th>Nama Skema</th>
                            <th>Jenis Skema</th>
                        ...
                        <?php
                            ...
                            <td class="namaskema"><?php echo $row['namaskema'];?></td>
                            <td><?php echo $row['jenisskema'];?></td>
                            <td><?php echo $row['jumlahunit'];?></td>
                            <td><a class="editskema" href="editskema.php">Edit </a><a> / </a><a class="editskema" href="hapusskema"> Hapus</a></td>
                        </tr><tr class="isi-tabel">
                        <?php endwhile;?></tr>
                    </table>
                </div>
                <a class="inputskema" href="inputskema.php">Input Skema Baru</a>
            </div>
        </div>
