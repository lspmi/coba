...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="//localhost/lspmi/useradmin/assets/css/stylemasterskema.css">
    </head>
    <body background="//localhost/lspmi/asset/picture/2.jpg">
        <div class="containerr">
            ...
            <div class="main-content">
                ...
                <div class="skema">
                    <h1>Input Data Skema baru</h1>
                    <form action=inputdataskema.php" method="POST" enctype="multipart/form-data">
                        <table class="tabel-input-skema">
                            <tr>
                                <td>Nama Skema</td><td></td>
                                <td>:</td>
                                <td><input type="text" name="namaskema"></td>
                            </tr>
                            <tr>
                                <td>Kode Skema</td><td></td>
                                <td>:</td>
                                <td><input type="text" name="kodeskema"></td>
                            </tr>
                            <tr>
                                <td>Jenis Skema</td><td></td>
                                <td>:</td>
                                <td><input type="text" name="jenisskema"></td>
                            </tr>
                            <tr>
                                <td>Jumlah Unit Kompetensi</td><td></td>
                                <td>:</td>
                                <td><input type="number" name="jumlahunit"></td>
                            </tr>
                            <tr>
                                <td>Harga Skema</td><td></td>
                                <td>:</td>
                                <td><input type="text" name="hargaskema"></td>
                            </tr>
                            <tr>
                                <td>Upload Dokumen Skema</td><td></td>
                                <td>:</td>
                                <td><input type="file" name="fileskema" value="upload"></td>
                            </tr>
                            <tr>
                                <td>Deskripsi Skema</td><td></td>
                                <td>:</td>
                                <td><textarea type="text" name="deskripsiskema"></textarea></td>
                            </tr>
                        </table>
                        <div class="simpan">
                        <button type="submit" class="btn" name="simpan" value="upload">Simpan</button>
                        </div>
                    </form>
                </div>
            </div>
