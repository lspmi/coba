...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="asset/css/styleskema.css">
    ...
    <body background="asset/picture/2.jpg">
        ...
        <div class="skema">
            <h1>SKEMA SERTIFIKASI LSP MEDIA INFORMATIKA</h1>
            <table class="list-skema">
                <tr class="judultabel">
                    <th>No.</th>
                    <th>Nama Skema</th>
                    <th>Jenis Skema</th>
                ...
                <?php
                    ...
                    <td><?php echo $row['hargaskema'];?></td>
                    <td><a href="detailskema.php">Detail Skema</a></td>
                </tr><tr>
                <?php endwhile;?></tr>
            </table>
        </div>
